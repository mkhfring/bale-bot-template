class AccountOfficerStatement:
    ...
    def __init__(self, start_date, end_date, branch_code=None,
        ...
        self.customer_search_condition = (
            ...
            " or officers.SSN = '{}' or officers.CELL_PHONE_NO = '{}')"
            .format(self.personnel_id, self.social_number, self.phone_number) if \
            self.social_number or self.personnel_id or self.phone_number else ""
        )
        self.officer_search_condition = (
            "and (supervisors.PERSONNEL_ID= '{}'"
            " or supervisors.SSN = '{}' or supervisors.CELL_PHONE_NO = '{}')"
                .format(self.personnel_id, self.social_number, self.phone_number) if \
                self.social_number or self.personnel_id or self.phone_number else ""
        )
