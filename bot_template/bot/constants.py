class ConstantMessage:
    ...
    customer_search_criterion = 'کد پرسنلی، کد ملی یا شماره همراه بانک آفیسر مورد نظر را *وارد* و یا تمام بانک آفیسرها را *انتخاب* کنید:'
    officer_search_criterion = 'کد پرسنلی، کد ملی یا شماره همراه ناظر مورد نظر را *وارد* و یا تمام بانک آفیسرها را *انتخاب* کنید:'
